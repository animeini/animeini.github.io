...
const trendingapi =
    "https://api.ini.lol/meta/anilist/trending?perPage=12";
const popularapi = "https://api.ini.lol/anime/gogoanime/top-airing";
const recentapi =
    "https://api.ini.lol/anime/gogoanime/recent-episodes?page=";
